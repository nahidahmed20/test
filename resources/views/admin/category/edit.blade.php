                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('category.update',['id' => $category->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description"   placeholder="Category Description" type="text">{{$category->description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="{{asset($category->image)}}" alt="" height="40" width="60">
                            </div>
                        </div>
                        <div class="row mb-4">
