                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            ...
                            <form action="{{route('cart.update')}}" method="post" >
                                @csrf
                                <input type="number" value="{{$cart_product->qty}}" name="qty" min="1" class="form-control">
                                <div class="input-group">
                                    <input type="hidden" value="{{$cart_product->rowId}}" name="rowId" class="form-control">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" onclick="return confirm('Are you sure to delete this...')" href="{{route('cart.remove',['rowId' => $cart_product->rowId])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach
